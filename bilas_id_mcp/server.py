...
mcp = MCPServer(
    ...
    description=(
        ...
        "  Reports:  bilas_get_ringkasan_outlet, bilas_get_pendapatan_transaksi, bilas_get_topup_paket,\n"
        "            bilas_get_topup_deposit, bilas_get_self_service_income, bilas_get_other_income,\n"
        "            bilas_get_piutang, bilas_get_pembulatan, bilas_get_merchant_fees,\n"
        ...
        "            bilas_add_expense, bilas_delete_expense\n"
        ...
        "  Customers: bilas_list_customers\n"
        "\n"
